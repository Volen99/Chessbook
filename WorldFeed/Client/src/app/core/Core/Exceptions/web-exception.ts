  ...
  import {WebExceptionStatus} from "./web-exception-status";
  ...
  */
  ...
  private m_Status: WebExceptionStatus = WebExceptionStatus.UnknownError; // Should be changed to GeneralFailure;
  private m_Response: WebResponse;
    // [NonSerialized]
  private m_InternalStatus: WebExceptionInternalStatus = WebExceptionInternalStatus.RequestFatal;
