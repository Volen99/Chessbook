...
namespace WorldFeed.Admin.Services.HistoryBCSciencePosts
{
    ...
    using global::WorldFeed.Admin.Models.HistoryBCSciencePosts;
    ...
    partial class AutoGeneratedIHistoryBCSciencePost : IHistoryBCSciencePost
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public AutoGeneratedIHistoryBCSciencePost(HttpClient client, IRequestBuilder requestBuilder)
        {
            Client = client;
        ...
        /// <inheritdoc />
        Task<IEnumerable<HistoryBCSciencePostOutputModel>> IHistoryBCSciencePost.All()
        {
            var arguments = new object[] {  };
            var func = requestBuilder.BuildRestResultFuncForMethod("All", new Type[] {  });
            return (Task<IEnumerable<HistoryBCSciencePostOutputModel>>)func(Client, arguments);
        }

        /// <inheritdoc />
        Task<HistoryBCSciencePostOutputModel> IHistoryBCSciencePost.Details(string id)
        {
            var arguments = new object[] { id };
            var func = requestBuilder.BuildRestResultFuncForMethod("Details", new Type[] { typeof(string) });
            return (Task<HistoryBCSciencePostOutputModel>)func(Client, arguments);
        }
    }
}
