namespace WorldFeed.Science.Upload.Infrastructure
{
    ...
    using WorldFeed.Science.Upload.Infrastructure.Extensions;
    using WorldFeed.Science.Upload.Domain.Common;

    public class ScienceUploadDbContext : DbContext, IUnitOfWork
    {
        ...
        public ScienceUploadDbContext(DbContextOptions<ScienceUploadDbContext> options) : base(options) 
        {
        }
        ...
        public ScienceUploadDbContext(DbContextOptions<ScienceUploadDbContext> options, IMediator mediator) : base(options)
        {
    ...
    public class OrderingContextDesignFactory : IDesignTimeDbContextFactory<ScienceUploadDbContext>
    {
        public ScienceUploadDbContext CreateDbContext(string[] args)
        {
            ...
            return new ScienceUploadDbContext(optionsBuilder.Options, new NoMediator());
        }
