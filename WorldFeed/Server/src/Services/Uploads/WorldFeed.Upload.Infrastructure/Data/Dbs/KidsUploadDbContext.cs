namespace WorldFeed.Upload.Infrastructure.Data.Dbs
{
    using System;
    ...
    public class KidsUploadDbContext : DbContext, IUnitOfWork
    {
        ...
        public KidsUploadDbContext(DbContextOptions<KidsUploadDbContext> options) : base(options) 
        {
        }
        ...
        public KidsUploadDbContext(DbContextOptions<KidsUploadDbContext> options, IMediator mediator) : base(options)
        {
    ...
    public class KidsUploadDesignFactory : IDesignTimeDbContextFactory<KidsUploadDbContext>
    {
        public KidsUploadDbContext CreateDbContext(string[] args)
        {
            ...
            return new KidsUploadDbContext(optionsBuilder.Options, new NoMediator());
        }
