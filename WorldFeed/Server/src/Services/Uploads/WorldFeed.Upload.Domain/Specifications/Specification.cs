namespace WorldFeed.Science.Upload.Domain.Specifications
{
    using System;
    ...
    // Very often used pattern in DDD. Even when some consider it to be an "anti-pattern"
    public abstract class Specification<T>
    {
        ...
        {
            if (specification.Include == false)
            {
                return this;
            }
