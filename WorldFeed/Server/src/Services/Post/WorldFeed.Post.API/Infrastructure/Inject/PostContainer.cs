namespace WorldFeed.Post.API.Infrastructure.Inject
{
    ...
    public class PostContainer : IPostContainer
    {
        ...
        private readonly List<IPostModule> moduleCatalog;
        ...
        public PostContainer()
        {
            ...
            this.moduleCatalog = new List<IPostModule>();

            this.RegisterModules();
            this.InitializeModules();
        }

        public PostContainer(IPostContainer container)
        {
        ...
        {
            this.moduleCatalog.Add(new PostModule());
            this.moduleCatalog.Add(new PostControllersModule());
            this.moduleCatalog.Add(new PostCoreModule(this));
            this.moduleCatalog.Add(new PostLogicModule());
            this.moduleCatalog.Add(new PostWebLogicModule());
        }
