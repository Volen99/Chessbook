namespace WorldFeed.Profile.Client.Clients
{
    ...
    using WorldFeed.Profile.Application.DTO.QueryDTO.Cursor;
    using WorldFeed.Profile.Application.Parameters.AccountClient;
    using WorldFeed.Profile.Application.Web;
    using WorldFeed.Profile.Client.Requesters;
    ...
    public class UsersClient : IUsersClient
    {
        ...
        private readonly IMultiLevelCursorIteratorFactory multiLevelCursorIteratorFactory;

        public UsersClient(ITwitterClient client, IMultiLevelCursorIteratorFactory multiLevelCursorIteratorFactory)
        {
            this.client = client;
            this.usersRequester = client.Raw.Users;
            this.multiLevelCursorIteratorFactory = multiLevelCursorIteratorFactory;
        }

        public IUsersClientParametersValidator ParametersValidator => this.client.ParametersValidator;
        ...
        {
            var requestResult = await this.usersRequester.GetAuthenticatedUserAsync(parameters).ConfigureAwait(false);
            return this.client.Factories.CreateAuthenticatedUser(requestResult?.Model);
        }
        ...
        {
            var requestResult = await this.usersRequester.GetUserAsync(parameters).ConfigureAwait(false);
            return this.client.Factories.CreateUser(requestResult?.Model);
        }
        ...
        public async Task<IUser[]> GetUsersAsync(IGetUsersParameters parameters)
        {
            ...
            var requestResult = await this.usersRequester.GetUsersAsync(parameters).ConfigureAwait(false);
            return this.client.Factories.CreateUsers(requestResult?.Model);
        }
        ...
        {
            var relationshipTwitterResult = await this.usersRequester.GetRelationshipBetweenAsync(parameters).ConfigureAwait(false);
            return this.client.Factories.CreateRelationshipDetails(relationshipTwitterResult?.Model);
        }
        ...
        {
            var twitterResultIterator = this.usersRequester.GetFriendIdsIterator(parameters);
        ...
        {
            var friendsPageIterator = this.usersRequester.GetFriendIdsIterator(parameters);

            var maxPageSize = this.client.Config.Limits.USERS_GET_USERS_MAX_SIZE;
            if (parameters.GetUsersPageSize > maxPageSize)
            {
                throw new TwitterArgumentLimitException($"{nameof(parameters.GetUsersPageSize)}", maxPageSize, nameof(this.client.Config.Limits.USERS_GET_USERS_MAX_SIZE),
                    "page size");
            }

            return this.multiLevelCursorIteratorFactory.CreateUserMultiLevelIterator(this.client, friendsPageIterator, maxPageSize);
        }
        ...
        {
            var followerIdsPageIterator = this.usersRequester.GetFollowerIdsIterator(parameters);
        ...
        {
            var followerPageIterator = this.usersRequester.GetFollowerIdsIterator(parameters);
            ...
            return this.multiLevelCursorIteratorFactory.CreateUserMultiLevelIterator(this.client, followerPageIterator, maxPageSize);
        }
        ...
        {
            var twitterResult = await this.usersRequester.BlockUserAsync(parameters).ConfigureAwait(false);
        ...
        {
            var twitterResult = await this.usersRequester.UnblockUserAsync(parameters).ConfigureAwait(false);
            return this.client.Factories.CreateUser(twitterResult?.Model);
        }
        ...
        {
            var twitterResult = await this.usersRequester.ReportUserForSpamAsync(parameters).ConfigureAwait(false);
            return this.client.Factories.CreateUser(twitterResult?.Model);
        }
        ...
        {
            var twitterCursorResult = this.usersRequester.GetBlockedUserIdsIterator(parameters);
        ...
        {
            var twitterCursorResult = this.usersRequester.GetBlockedUsersIterator(parameters);
            return new TwitterIteratorProxy<ITwitterResult<IUserCursorQueryResultDTO>, IUser>(twitterCursorResult, pageResult =>
            {
                ...
                return this.client.Factories.CreateUsers(userDTOs);
            });
        }
        ...
        {
            var twitterResult = await this.usersRequester.FollowUserAsync(parameters).ConfigureAwait(false);
            return this.client.Factories.CreateUser(twitterResult?.Model);
        }
        ...
        {
            var twitterResult = await this.usersRequester.UnfollowUserAsync(parameters).ConfigureAwait(false);
            return this.client.Factories.CreateUser(twitterResult?.Model);
        }
        ...
        {
            await this.usersRequester.UpdateRelationshipAsync(parameters).ConfigureAwait(false);
        }
        ...
        {
            var iterator = this.usersRequester.GetUserIdsRequestingFriendshipIterator(parameters);
        ...
        public IMultiLevelCursorIterator<long, IUser> GetUsersRequestingFriendshipIterator(IGetUsersRequestingFriendshipParameters parameters)
        {
            ...
            if (parameters.GetUsersPageSize > maxPageSize)
            {
                throw new TwitterArgumentLimitException($"{nameof(parameters.GetUsersPageSize)}", maxPageSize, nameof(this.client.Config.Limits.USERS_GET_USERS_MAX_SIZE), "page size");
            }

            return this.multiLevelCursorIteratorFactory.CreateUserMultiLevelIterator(this.client, iterator, maxPageSize);
        }
        ...
        {
            var iterator = this.usersRequester.GetUserIdsYouRequestedToFollowIterator(parameters);
            return new TwitterIteratorProxy<ITwitterResult<IIdsCursorQueryResultDTO>, long>(iterator, dto => dto.Model.Ids);
        }
        ...
        public async Task<IUserDictionary<IRelationshipState>> GetRelationshipsWithAsync(IGetRelationshipsWithParameters parameters)
        {
            ...
            var twitterResult = await this.usersRequester.GetRelationshipsWithAsync(parameters).ConfigureAwait(false);
            var relationshipsWith = this.client.Factories.CreateRelationshipStates(twitterResult?.Model);
        ...
        {
            var twitterResult = await this.usersRequester.GetUserIdsWhoseRetweetsAreMutedAsync(parameters).ConfigureAwait(false);
        ...
        {
            var iterator = this.usersRequester.GetMutedUserIdsIterator(parameters);
            return new TwitterIteratorProxy<ITwitterResult<IIdsCursorQueryResultDTO>, long>(iterator, dto => dto.Model.Ids);
        }
        ...
        {
            var iterator = this.usersRequester.GetMutedUsersIterator(parameters);
        ...
        {
            var twitterResult = await this.usersRequester.MuteUserAsync(parameters).ConfigureAwait(false);
            return this.client.Factories.CreateUser(twitterResult?.Model);
        }
        ...
        {
            var twitterResult = await this.usersRequester.UnmuteUserAsync(parameters).ConfigureAwait(false);
            return this.client.Factories.CreateUser(twitterResult?.Model);
        }
        ...
        {
            return this.usersRequester.GetProfileImageStream(parameters);
        }
