namespace WorldFeed.Identity.Infrastructure.Repositories
{
    using System;
    using System.Linq;
    ...
    public class EfRepository<TEntity> : IRepository<TEntity>
        where TEntity : class
    {
        public EfRepository(ScienceUploadDbContext context)
        {
        ...
        protected ScienceUploadDbContext Context { get; set; }
