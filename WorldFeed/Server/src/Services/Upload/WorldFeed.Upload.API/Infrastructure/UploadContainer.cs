namespace WorldFeed.Upload.Infrastructure
{
    using System;
    ...
    {
        public static IUploadContainer Container;
        ...
        /// </summary>
        public static event EventHandler<UploadContainerEventArgs> BeforeRegistrationComplete;

        static UploadContainer()
        {
            Container = new Inject.UploadContainer();
            Container.BeforeRegistrationCompletes += ContainerOnBeforeRegistrationCompletes;
        }

        private static void ContainerOnBeforeRegistrationCompletes(object sender, UploadContainerEventArgs args)
        {
        ...
        public static void AddModule(IUploadModule module)
        {
            lock (_resolveLock)
            {
                var updatedContainer = new Inject.UploadContainer(Container);
