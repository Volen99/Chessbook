namespace WorldFeed.Upload.Exceptions
{
    ...
    {
        private readonly IWebExceptionInfoExtractor webExceptionInfoExtractor;

        public TwitterExceptionFactory(IWebExceptionInfoExtractor webExceptionInfoExtractor)
        {
            this.webExceptionInfoExtractor = webExceptionInfoExtractor;
        }
        ...
        {
            return new TwitterException(this.webExceptionInfoExtractor, twitterResponse, request);
        }

        public TwitterException Create(WebException webException, ITwitterRequest request)
        {
            return new TwitterException(this.webExceptionInfoExtractor, webException, request);
        }

        public TwitterException Create(WebException webException, ITwitterRequest request, int statusCode)
        {
            return new TwitterException(this.webExceptionInfoExtractor, webException, request, statusCode);
        }
    }
    ...
    public class TwitterException : WebException, ITwitterException
    {
        ...
        public TwitterException(IWebExceptionInfoExtractor webExceptionInfoExtractor, WebException webException, ITwitterRequest request, int statusCode)
            : this(request, webException.Message)
        {
            WebException = webException;
