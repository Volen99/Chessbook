...
export class NbToastrService {
   ...
   * */
  success(message, title?, config?: Partial<NbToastrConfig>, url?: string): NbToastRef {
    return this.show(message, title, { ...config, status: 'success' }, url);
  }
