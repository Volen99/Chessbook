...
import {ChessbookRouterService, RouterSetting} from './chessbook-router.service';
...
export class ScrollService {
  ...
  constructor(
    ...
    private peertubeRouter: ChessbookRouterService
  ) {
  }
    ...
    this.peertubeRouter.getNavigationEndEvents().pipe(pairwise())
      .subscribe(([e1, e2]) => {
        try {
          ...
          nextSearchParams.delete(ChessbookRouterService.ROUTE_SETTING_NAME);
