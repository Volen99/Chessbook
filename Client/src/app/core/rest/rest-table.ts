...
export abstract class RestTable {
  ...
  loadSort() {
    const result = chessbookLocalStorage.getItem(this.getSortLocalStorageKey());
  ...
  saveSort() {
    chessbookLocalStorage.setItem(this.getSortLocalStorageKey(), JSON.stringify(this.sort));
  }
