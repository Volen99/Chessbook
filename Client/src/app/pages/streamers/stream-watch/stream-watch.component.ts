      ...
      if (loginName) {
        this.streamersService.getLiveStreamByUserLogin(loginName)
          .subscribe((data: IStreams) => {
            ...
            this.streamUrl = `https://player.twitch.tv/?channel=${this.stream.user_login}&parent=chessbook.me&autoplay=true`;
            this.chatUrl = `https://www.twitch.tv/embed/${this.stream.user_login}/chat?parent=chessbook.me`;
          });
      }
    });
  }
