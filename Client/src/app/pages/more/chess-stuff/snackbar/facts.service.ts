...
export class FactsService {
  private facts: string[] = [
    ...
    'Samsung tests phone durability with a butt-shaped robot <img src="/assets/images/icons/dope/robot.png" width="28" height="28">',
    'There were active volcanoes on the moon when dinosaurs were alive 🐱‍🐉',
    'You only have two body parts that never stop growing nose 👃🏼 and ears 👂🏼',
    ...
    'It snowed in the Sahara desert for 30 minutes on February 18, 1979, followed by December 2016 and January 2018 🌨',
    ...
    'Magnus Carlsen reached number one in the FIDE world rankings aged 19, becoming the youngest person ever to achieve this',
    'Alireza Firouzja surpassed a rating of 2800 at age 18 becoming the youngest person ever to achieve this',
    ...
    'Amazingly, one of NASA’s flagship spacecraft, the Space Shuttle, runs on less code than many of today’s cellphones and other gadgets <img src="/assets/images/icons/dope/iphone.png" width="28" height="28">',
    ...
    'The Wow! signal was a strong narrowband radio signal detected on August 15, 1977, by the Ohio State University\'s Big Ear radio telescope in the United States 👽',
    '👽 Wow! 6EQUJ5 Wow! 👽',
    ...
    'Between July 9 and July 10, 1856 during a fierce lightning storm, midwife said this child will be a child of darkness, to which Nikola Tesla\'s mother replied: “No. He will be a child of light.”',
    ...
    'Your cellphone is more powerful than Apollo 11’s computers <img src="/assets/images/icons/dope/iphone.png" width="28" height="28">',
    '“The Eagle has landed,” is one of the most famous quotes in NASA history 🌑🦅<img src="/assets/images/icons/dope/nasa.png" width="28" height="28">',
    ...
    'Alan Turing invented the “Turing Test” (one of the Turing tests is CAPTCHA) 🤖',
    ...
    'The original name of Google was Backrub <img src="/assets/images/icons/dope/google.png" width="40" height="40">',
    '<span>Scientists have calculated that there are between 10<sup>78</sup> to 10<sup>82</sup> atoms in the observable universe</span>',
    `<a href="https://mars.nasa.gov/msl/multimedia/raw-images" target="_blank">Click me to wake your curiosity</a>`,
    'Go is an abstract strategy board game for two players in which the aim is to surround more territory than the opponent <img src="/assets/images/go-stone.png" width="24" height="24">',
