...
import {About} from "../models/server/about.model";
...
export class InstanceService {
  ...
  constructor(private authHttp: HttpClient, private restExtractor: RestExtractor,
              private markdownService: MarkdownService, private serverService: ServerService) {
  }
