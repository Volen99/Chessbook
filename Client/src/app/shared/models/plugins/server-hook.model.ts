...
export const serverFilterHookObject = {
  ...
  // Filter the result of the accept reply-comment (thread or reply) functions
  // If the functions return false then the users cannot post its reply-comment
...
export const serverActionHookObject = {
  ...
  // Fired when a reply-comment (thread or reply) is deleted
