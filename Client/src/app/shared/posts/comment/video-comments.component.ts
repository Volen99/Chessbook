...
export class VideoCommentsComponent implements OnInit, OnChanges, OnDestroy {
  ...
  ngOnInit() {
    // Find highlighted reply-comment in params
  ...
  viewReplies(commentId: number, highlightThread = false) {
    ...
    const obs =  this.videoCommentService.getVideoThreadComments(params);
  ...
  loadMoreThreads() {
    ...
    const obs = this.videoCommentService.getVideoCommentThreads(params);
    ...
    this.videoCommentService.deleteVideoComment(commentToDelete.videoId, commentToDelete.id)
      .subscribe(
        () => {
          ...
          // Mark the reply-comment as deleted
