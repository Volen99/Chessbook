import {BooleanBothQuery, BooleanQuery} from "../models/search/boolean-both-query.model";
import {SearchTargetType} from "../models/search/search-target-query.model";
import {VideosSearchQuery} from "../models/search/videos-search-query.model";
import {VideoPlaylistsSearchQuery} from "../models/search/video-playlists-search-query.model";
import {VideoChannelsSearchQuery} from "../models/search/video-channels-search-query.model";
