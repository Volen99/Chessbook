...
let chessbookLocalStorage: Storage;
...
function reinitStorage() {
  ...
  chessbookLocalStorage = proxify(instanceLocalStorage);
  sharebookSessionStorage = proxify(instanceSessionStorage);
}

try {
  chessbookLocalStorage = localStorage;
...
if (chessbookLocalStorage === null || sharebookSessionStorage === null) {
  reinitStorage();
}

export {
  chessbookLocalStorage,
