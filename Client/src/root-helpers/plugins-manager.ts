...
import {
  ClientHookName, clientHookObject,
  ClientScript, PluginClientScope,
  PluginType,
  RegisterClientFormFieldOptions,
  RegisterClientHookOptions, RegisterClientVideoFieldOptions
} from "../app/shared/models";
import {HTMLServerConfig, ServerConfigPlugin} from "../app/shared/models/server/server-config.model";
...
class PluginsManager {
  ...
  private loadPlugin(pluginInfo: PluginInfo) {
    ...
    return import(/* webpackIgnore: true */ absURL)
      .then((script: ClientScriptModule) => script.register({
        registerHook,
        registerVideoField,
