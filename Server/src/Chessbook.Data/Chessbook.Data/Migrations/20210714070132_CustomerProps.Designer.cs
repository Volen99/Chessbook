...
namespace Chessbook.Data.Migrations
{
    ...
    [Migration("20210714070132_CustomerProps")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chessbook.Data.Models.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Chessbook.Data.Models.Polls.PollAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Nop.Core.Domain.Catalog.PostPicture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Chessbook.Data.Models.Comments.Comment", b =>
                {
                    ...
                    b.HasOne("Chessbook.Data.Models.Customer", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Chessbook.Data.Models.UserClaim", b =>
                {
                    b.HasOne("Chessbook.Data.Models.Customer", null)
                        .WithMany("Claims")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
