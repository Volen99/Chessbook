...
namespace Chessbook.Data.DataProviders
{
    ...
    public partial class MsSqlNopDataProvider : BaseDataProvider, INopDataProvider
    {
        ...
        public async void CreateDatabase(string collation, int triesToConnect = 10) // async by mi
        {
            if (DatabaseExists())
            {
                return;
            ...
            {
                var query2 = @"CREATE TABLE [dbo].[DistributedCache]
                (
                ...
                await currentConnection.ExecuteAsync(query2);
            }
