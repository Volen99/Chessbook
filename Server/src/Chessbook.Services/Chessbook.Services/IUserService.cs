namespace Chessbook.Services.Data.Services
{
    ...
    public interface IUserService
    {
        ...
        Task Update(Customer user); // pff ...map that thing already!
        ...
        Task<IPagedList<Customer>> GetWhoToFollowUsers(UsersGridFilter filter, int userId, int[] userRoleIds, bool getOnlyTotalCount);
