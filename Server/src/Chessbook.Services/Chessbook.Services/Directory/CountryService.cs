...
namespace Chessbook.Services.Directory
{
    ...
    public partial class CountryService : ICountryService
    {
        ...
        /// </returns>
        public virtual async Task<Country> GetCountryByAddressAsync(object address)
        {
        ...
        public virtual async Task<Country> GetCountryByTwoLetterIsoCodeAsync(string twoLetterIsoCode)
        {
            ...
            return await _staticCacheManager.GetAsync(key, async () => await query.FirstOrDefaultAsyncExt());
        }
