...
namespace Nop.Services.Helpers
{
    ...
    public partial class UserAgentHelper : IUserAgentHelper
    {
        ...
        public UserAgentHelper(AppSettings appSettings, IHttpContextAccessor httpContextAccessor, INopFileProvider fileProvider)
        {
        ...
        protected virtual BrowscapXmlHelper GetBrowscapXmlHelper()
        {
            ...
            //no database created
            if (string.IsNullOrEmpty("~/App_Data/browscap.xml"))
                return null;
            ...
            lock (_locker)
            {
                ...
                var userAgentStringsPath = _fileProvider.MapPath("~/App_Data/browscap.xml");
                var crawlerOnlyUserAgentStringsPath = !string.IsNullOrEmpty("~/App_Data/browscap.crawlersonly.xml")
                    ? _fileProvider.MapPath("~/App_Data/browscap.crawlersonly.xml")
                    : string.Empty;
