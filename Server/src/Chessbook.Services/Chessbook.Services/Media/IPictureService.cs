...
namespace Chessbook.Services.Data.Services.Media
{
    ...
    public interface IPictureService
    {
        ...
        /// </returns>
        Task<IList<Picture>> GetPicturesAsync(string virtualPath = "", int pageIndex = 0, int pageSize = int.MaxValue);
        ...
        /// The task result contains the picture
        /// </returns>
        Task<Picture> GetProductPictureAsync(Post product, string attributesXml);
