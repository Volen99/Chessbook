...
using Chessbook.Core.Security;
using Chessbook.Data;
using Chessbook.Services.Configuration;
using Chessbook.Services.Security;
using Chessbook.Web.Framework.Security.Captcha;
...
namespace Chessbook.Web.Framework.Infrastructure.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static (IEngine, AppSettings) ConfigureApplicationServices(this IServiceCollection services, IConfiguration configuration, IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            var appSettings = Singleton<AppSettings>.Instance;
            if (false) // appSettings.AzureBlobConfig.Enabled && appSettings.AzureBlobConfig.StoreDataProtectionKeys
            {
