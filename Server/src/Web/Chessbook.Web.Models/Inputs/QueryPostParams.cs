namespace Chessbook.Web.Models.Inputs
{
    ...
    public class QueryPostParams
    {
        ...
        [BindProperty(Name = "in_reply_to_status_id_str")]
        public string InReplyToStatusIdStr { get; set; }

        [BindProperty(Name = "in_reply_to_user_id")]
        public int? InReplyToUserId { get; set; }

        [BindProperty(Name = "in_reply_to_user_id_str")]
        public string InReplyToUserIdStr { get; set; }

        [BindProperty(Name = "in_reply_to_screen_name")]
