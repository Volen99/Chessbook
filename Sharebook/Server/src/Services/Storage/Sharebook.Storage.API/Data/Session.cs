namespace Sharebook.Storage.API.Data
{
    ...
    public class Session
    {
        ...
        public Session(FileInformation fileInfo) : this(fileInfo, DEFAULT_TIMEOUT)
        {

        }

        public Session(FileInformation fileInformation, long timeout)
        {
            this.MediaId = ++Global.LastMediaId;
