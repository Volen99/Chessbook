namespace Sharebook.Storage.API.Data.Models.Properties
{
    ...
    {
        public Place(string idStr, string name, string fullName, string url, PlaceType placeType, string country, string countryCode, Dictionary<string, string> attributes, List<Place> containedWithin, Geo boundingBox, Geo geometry)
        {
            this.IdStr = idStr;
            this.Name = name;
