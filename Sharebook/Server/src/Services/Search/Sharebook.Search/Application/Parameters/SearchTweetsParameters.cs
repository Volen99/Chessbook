namespace Sharebook.Search.Application.Parameters
{
    using System;
    ...
    using Sharebook.Common.Public.Parameters.Enums;
    ...
    public class SearchTweetsParameters : MinMaxQueryParameters, ISearchTweetsParameters
    {
        private SearchTweetsParameters()
        {
            ...
            PageSize = WorldFeedLimits.DEFAULTS.SEARCH_TWEETS_MAX_PAGE_SIZE;
        }
