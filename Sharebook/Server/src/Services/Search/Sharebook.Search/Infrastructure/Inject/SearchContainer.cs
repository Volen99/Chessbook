namespace Sharebook.Search.Infrastructure.Inject
{
    ...
    using Sharebook.Post.API.Infrastructure.Inject;
    using Sharebook.Search.Application.IntegrationEvents.Events;
    using Sharebook.Search.Infrastructure.AutofacModules;
    ...
    public class SearchContainer : ISearchContainer
    {
        ...
        private readonly List<ISearchModule> moduleCatalog;
        ...
        public SearchContainer()
        {
            ...
            this.moduleCatalog = new List<ISearchModule>();

            this.RegisterModules();
            this.InitializeModules();
        }

        public SearchContainer(ISearchContainer container)
        {
        ...
        public event EventHandler<SearchContainerEventArgs> BeforeRegistrationCompletes;
        ...
        public void Initialize()
        {
            lock (_lock)
            {
                ...
                this.Raise(BeforeRegistrationCompletes, new SearchContainerEventArgs(this));
                this.BuildContainer();
            }
        }
        ...
        {
            this.moduleCatalog.Add(new SearchModule());
            this.moduleCatalog.Add(new SearchControllersModule());
            this.moduleCatalog.Add(new SearchCoreModule(this));
            this.moduleCatalog.Add(new SearchLogicModule());
            this.moduleCatalog.Add(new SearchWebLogicModule());
        }
