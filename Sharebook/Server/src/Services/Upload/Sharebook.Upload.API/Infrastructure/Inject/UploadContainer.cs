namespace Sharebook.Upload.Infrastructure.Inject
{
    ...
    using Sharebook.Controllers;
    using Sharebook.Upload.API.Infrastructure.Inject;
    using Sharebook.Upload.API.JsonConverters;
    using Sharebook.Upload.Infrastructure.Inject.Contracts;

    public class UploadContainer : IUploadContainer
    {
        private IContainer container;
        private readonly ContainerBuilder containerBuilder;
        private readonly List<IUploadModule> moduleCatalog;
        ...
        public UploadContainer()
        {
            ...
            this.moduleCatalog = new List<IUploadModule>();

            this.RegisterModules();
            this.InitializeModules();
        }

        public UploadContainer(IUploadContainer container)
        {
        ...
        public void Initialize()
        {
            lock (_lock)
            {
                ...
                this.Raise(BeforeRegistrationCompletes, new UploadContainerEventArgs(this));
                this.BuildContainer();
            }
        }
        ...
        {
            this.moduleCatalog.Add(new UploadModule());
            this.moduleCatalog.Add(new UploadControllersModule());
            this.moduleCatalog.Add(new UploadCoreModule(this));
            this.moduleCatalog.Add(new UploadLogicModule());
            this.moduleCatalog.Add(new UploadWebLogicModule());
        }
