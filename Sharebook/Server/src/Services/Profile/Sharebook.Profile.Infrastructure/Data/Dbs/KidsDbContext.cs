namespace Sharebook.Post.Infrastructure.Data.Dbs
{
    using System;
    ...
    public class KidsDbContext : DbContext, IUnitOfWork
    {
        ...
        public KidsDbContext(DbContextOptions<KidsDbContext> options) : base(options) 
        {
        }
        ...
        public KidsDbContext(DbContextOptions<KidsDbContext> options, IMediator mediator) : base(options)
        {
    ...
    public class KidsUploadDesignFactory : IDesignTimeDbContextFactory<KidsDbContext>
    {
        public KidsDbContext CreateDbContext(string[] args)
        {
            var optionsBuilder = new DbContextOptionsBuilder<KidsDbContext>()
                .UseSqlServer("Server=.;Initial Catalog=WorldFeed.Services.KidsUploadDb;Integrated Security=true");

            return new KidsDbContext(optionsBuilder.Options, new NoMediator());
        }
