namespace Sharebook.Profile.Domain.AggregatesModel.UserAggregate
{
    ...
    using global::Sharebook.Common.Models.Authentication;
    using global::Sharebook.Common.Public.Models.Interfaces;
    using global::Sharebook.Common.Public.Parameters.AccountClient;
    using global::Sharebook.Common.Public.Parameters.MessageClient;
    using global::Sharebook.Common.Public.Parameters.TweetsClient;


    /// <summary>
    /// A token user is unique to a Token and provides action that will be executed from the connected user and that are not available
