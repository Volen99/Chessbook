namespace Sharebook.Book.Infrastructure.Inject
{
    ...
    using Sharebook.Book.API.Infrastructure.Inject;
    using Sharebook.Book.Application.IntegrationEvents.Events;
    using Sharebook.Book.Infrastructure.AutofacModules;
