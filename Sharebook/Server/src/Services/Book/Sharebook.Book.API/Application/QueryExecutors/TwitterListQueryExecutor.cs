namespace Sharebook.Book.Application.QueryExecutors
{
    ...
    using Sharebook.Book.Application.QueryGenerators;
    using Sharebook.Book.DTO;
    using Sharebook.Book.DTO.QueryDTO.Cursor;
    using Sharebook.Common.Public.Models.Enums;
    using Sharebook.Common.Public.Models.Interfaces.DTO;
    using Sharebook.Common.Public.Parameters.ListsClient;
