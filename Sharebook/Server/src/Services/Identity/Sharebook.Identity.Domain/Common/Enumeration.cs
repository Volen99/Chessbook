namespace WorldFeed.Identity.Domain.Common
{
    using System;
    ...
    // When you implement IComparable, you can put it in sorted Dictionary, sorted array, list etc.. You can sort them by default
    public abstract class Enumeration : IComparable
    {
        ...
        // Get all the values from the current given enum
