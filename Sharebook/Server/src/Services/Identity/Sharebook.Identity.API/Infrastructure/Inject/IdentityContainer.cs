namespace Sharebook.Identity.API.Infrastructure.Inject
{
    ...
    public class IdentityContainer : IIdentityContainer
    {
        ...
        private readonly List<IIdentityModule> moduleCatalog;
        ...
        public IdentityContainer()
        {
            ...
            this.moduleCatalog = new List<IIdentityModule>();

            RegisterModules();
            InitializeModules();
        }

        public IdentityContainer(IdentityContainer container)
        {
            RegistrationActions = new List<Action<ContainerBuilder>>();
            this.containerBuilder = new ContainerBuilder();
        ...
        public void Initialize()
        {
            lock (_lock)
            {
                ...
                this.Raise(BeforeRegistrationCompletes, new IdentityContainerEventArgs(this));
                this.BuildContainer();
            }
        }
        ...
        {
            this.moduleCatalog.Add(new IIdentityModule());
