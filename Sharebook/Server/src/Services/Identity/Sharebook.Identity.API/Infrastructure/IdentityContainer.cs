namespace Sharebook.Identity.API.Infrastructure
{
    using System;
    ...
    public static class IdentityContainer
    {
        ...
        {
            this.Container = new Sharebook.Identity.API.Infrastructure.Inject.IdentityContainer();
        ...
        public static void AddModule(ITweetinviModule module)
        {
            lock (_resolveLock)
            {
                var updatedContainer = new Sharebook.Identity.API.Infrastructure.Inject.IdentityContainer(Container);
