...
namespace Sharebook.Data.Migrations
{
    ...
    [Migration("20210121113411_Roles")]
    partial class Roles
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sharebook.Data.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("Sharebook.Data.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Sharebook.Data.Models.Setting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Sharebook.Data.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Sharebook.Data.Models.ApplicationUser", null)
                        .WithMany("Claims")
