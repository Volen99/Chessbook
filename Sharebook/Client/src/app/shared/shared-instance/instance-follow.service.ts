...
import {ActivityPubActorType} from "../models/activitypub";
import {ResultList} from "../models/result-list.model";
import {ActorFollow, FollowState} from "../models/actors/follow.model";
...
export class InstanceFollowService {
  ...
  getFollowing(options: {
    ...
    if (actorType) {
      params = params.append('actorType', actorType);
    }
