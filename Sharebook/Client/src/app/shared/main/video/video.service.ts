...
import {VideoDetails as VideoDetailsServerModel} from '../../../shared/main/video/video-details.model';
...
import {VideoFilter} from "../../models/videos/video-query.type";
...
import {VideoFileMetadata} from "../../models/videos/video-file-metadata";
import {UserVideoRate} from "../../models/videos/rate/user-video-rate.model";
import {VideoPrivacy} from "../../models/videos/video-privacy.enum";
import {VideoConstant} from "../../models/videos/video-constant.model";
import {UserVideoRateUpdate} from "../../models/videos/rate/user-video-rate-update.model";
import {UserVideoRateType} from "../../models/videos/rate/user-video-rate.type";
