...
import { ServerConfig, VideoPlaylistElementType, VideoPlaylistElementUpdate } from '../models';
import { VideoPlaylistElement } from './video-playlist-element.model';
import { VideoPlaylist } from './video-playlist.model';
import { VideoPlaylistService } from './video-playlist.service';

@Component({
  selector: 'app-video-playlist-element-miniature',
...
export class VideoPlaylistElementMiniatureComponent implements OnInit {
  ...
  formatTimestamp(playlistElement: VideoPlaylistElement) {
    ...
    const startFormatted = 0; // secondsToTime(start, true, ':');
    const stopFormatted = 1; // secondsToTime(stop, true, ':');
