...
import {VideoExistInPlaylist, VideosExistInPlaylists} from "../models/videos/playlist/video-exist-in-playlist.model";
...
import {VideoPlaylistReorder} from "../models/videos/playlist/video-playlist-reorder.model";
...
export class VideoPlaylistService {
  ...
  listMyPlaylistWithCache(user: AuthUser, search?: string) {
    if (!search) {
      if (this.myAccountPlaylistCacheRunning) {
        return this.myAccountPlaylistCacheRunning;
      }
    ...
    if (!search) {
      this.myAccountPlaylistCacheRunning = obs;
    }
    return obs;
  }
