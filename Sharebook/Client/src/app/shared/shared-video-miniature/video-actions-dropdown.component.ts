...
import {VideoDetails} from "../main/video/video-details.model";
import {VideoCaption} from "../models/videos/caption/video-caption.model";
import {DropdownAction, DropdownButtonSize, DropdownDirection} from "../main/buttons/action-dropdown.component";
...
import {RedundancyService} from "../main/video/redundancy.service";
...
export class VideoActionsDropdownComponent implements OnChanges {
  ...
  loadDropdownInformation() {
    if (!this.isUserLoggedIn() || this.loaded === true) {
      return;
    }
