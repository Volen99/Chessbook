...
import {DropdownAction} from "../main/buttons/action-dropdown.component";
...
import {AdminAbuse} from "../../shared/models/moderation/abuse/abuse.model";
...
export class AbuseListTableComponent extends RestTable implements OnInit, AfterViewInit {
  ...
  updateAbuseState(abuse: any, state: AbuseState) {
    ...
    return observable.subscribe(
      async resultList => {
        ...
        for (const a of resultList.data) {
          ...
          if (abuse.updatedAt === abuse.createdAt) {
            delete abuse.updatedAt;
          }
