...
import { AuthService, ConfirmService, Notifier, ServerService, UserService } from '../../core';
import { Account } from '../../shared/shared-main/account/account.model';
import { BulkRemoveCommentsOfBody, ServerConfig, User, UserRight } from '../models';
import { BlocklistService } from './blocklist.service';
import { BulkService } from './bulk.service';
import { UserBanModalComponent } from './user-ban-modal.component';
import { DropdownAction } from '../shared-main';
      ...
      if (this.account) {
        ...
        this.userActions.push([
          ...
          },
          {
            ...
            handler: ({ account }) => this.bulkRemoveCommentsOf({
              accountName: account.nameWithHost,
              scope: 'my-videos'
            })
          }
        ]);
