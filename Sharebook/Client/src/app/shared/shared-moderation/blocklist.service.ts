...
import {AccountBlock as AccountBlockServer} from '../../shared/models/moderation/account-block.model';
...
export class BlocklistService {
  ...
  constructor(private authHttp: HttpClient, private restExtractor: RestExtractor, private restService: RestService) {
  }
