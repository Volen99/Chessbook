...
import {VideoBlacklist, VideoBlacklistType} from "../models/videos/blacklist/video-blacklist.model";
    ...
    if (search) {
      const filters = this.restService.parseQueryStringFilter(search, {
        type: {
          ...
          handler: v => {
            if (v === 'manual') {
              return VideoBlacklistType.MANUAL;
            }
            if (v === 'auto') {
              return VideoBlacklistType.AUTO_BEFORE_PUBLISHED;
            }
