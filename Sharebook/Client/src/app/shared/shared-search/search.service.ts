...
import { ComponentPaginationLight, RestExtractor, RestPagination, RestService } from '../../core';
import { Video, VideoChannel, VideoChannelService, VideoService } from '../../shared/shared-main';
import { ResultList, SearchTargetType, Video as VideoServerModel, VideoChannel as VideoChannelServerModel } from '../models';
...
export class SearchService {
  ...
  constructor(
    ...
    const searchUrl = sharebookLocalStorage.getItem('search-url');
