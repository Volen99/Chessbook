...
import { ConfirmService, MarkdownService, Notifier, RestPagination, RestTable } from '../../core';
import { DropdownAction, Video, VideoService } from '../../shared/shared-main';
import { Account } from '../../shared/shared-main/account/account.model';
import { AbuseService, BlocklistService, VideoBlockService } from '../../shared/shared-moderation';
import { VideoCommentService } from '../../shared/shared-video-comment';
import { AbuseMessageModalComponent } from './abuse-message-modal.component';
import { ModerationCommentModalComponent } from './moderation-comment-modal.component';
import { ProcessedAbuse } from './processed-abuse.model';
import { AbuseState, AdminAbuse } from '../models';
import { environment } from '../../../environments/environment';
import { Actor } from '../shared-main/account/actor.model';

const logger = debug('sharebook:moderation:AbuseListTableComponent');

@Component({
  selector: 'app-abuse-list-table',
    ...
    return observable.subscribe(
      async resultList => {
        ...
        for (const a of resultList.data) {
          ...
          if (abuse.video) {
            abuse.embedHtml = this.sanitizer.bypassSecurityTrustHtml( null /*this.getVideoEmbed(abuse)*/);
