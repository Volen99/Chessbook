...
import { ComponentPaginationLight, RestExtractor, RestService, User, SharebookSocket, AuthService } from '@app/core';
import { ResultList, UserNotification as UserNotificationServer, UserNotificationSetting } from '../../models';
...
export class UserNotificationService {
    ...
    constructor(
        ...
        private sharebookSocket: SharebookSocket
    ) {
    }
    ...
    markAsRead(notification: UserNotification) {
        ...
        return this.authHttp.post(url, body, { headers })
            .pipe(
                ...
                tap(() => this.sharebookSocket.dispatchNotificationEvent('read')),
    ...
    markAllAsRead() {
        ...
        return this.authHttp.post(url, {}, { headers })
            .pipe(
                map(this.restExtractor.extractDataBool),
                tap(() => this.sharebookSocket.dispatchNotificationEvent('read-all')),
                catchError(res => this.restExtractor.handleError(res))
            );
    }
