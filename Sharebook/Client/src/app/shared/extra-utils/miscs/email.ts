...
class MockSmtpServer {
    ...
    private emailChildProcess: any; // ChildProcess;
    private emails: object[];

    private constructor() {
        this.emailChildProcess = null; // fork(`${__dirname}/email-child-process`, []);
    ...
    collectEmails(emailsCollection: object[]) {
        return new Promise<number>((res, rej) => {
            const port = 0 // parallelTests() ? randomInt(1000, 2000) : 1025;
