...
const videosRoutes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'upload',
        loadChildren: () => import('../videos/+video-edit/video-add.module').then(m => m.VideoAddModule),
        data: {
          meta: {
      ...
      {
        path: 'update/:uuid',
        loadChildren: () => import('../videos/+video-edit/video-update.module').then(m => m.VideoUpdateModule),
        data: {
          meta: {
      ...
      {
        path: 'watch',
        loadChildren: () => import('../videos/+video-watch/video-watch.module').then(m => m.VideoWatchModule),
        data: {
          preload: 3000
        }
      }
