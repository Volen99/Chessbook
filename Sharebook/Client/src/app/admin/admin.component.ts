...
import {TopMenuDropdownParam} from "../shared/main/misc/top-menu-dropdown.component";
import {AuthService} from "../core/auth/auth.service";

// I am the dumbest person on planet earth | 07.01.2020 | CLANN - I Hold You
@Component({
...
export class AdminComponent implements OnInit {
  ...
  ngOnInit() {
    const federationItems: TopMenuDropdownParam = {
      ...
      children: [
        ...
        },
        {
          ...
          routerLink: '/admin/follows/video-redundancies-list.ts',
          iconName: 'videos'
        }
      ]
    };
    ...
    if (this.hasServerFollowRight()) {
      this.menuEntries.push(federationItems);
    }
    if (this.hasAbusesRight() || this.hasVideoBlocklistRight()) {
      this.menuEntries.push(moderationItems);
    }
