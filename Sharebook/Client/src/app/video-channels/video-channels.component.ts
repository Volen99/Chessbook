...
import { AuthService, Notifier, RestExtractor, ScreenService } from '../core';
import { ListOverflowItem, VideoChannel, VideoChannelService } from '../shared/shared-main';
...
export class VideoChannelsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.links = [
      ...
      {
        label: $localize`VIDEO PLAYLISTS`,
        routerLink: 'video-playlists'
      },
      {
