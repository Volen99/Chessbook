...
export class AuthService {
  ...
  private clientId: string = sharebookLocalStorage.getItem(AuthService.LOCAL_STORAGE_OAUTH_CLIENT_KEYS.CLIENT_ID);
  private clientSecret: string = sharebookLocalStorage.getItem(AuthService.LOCAL_STORAGE_OAUTH_CLIENT_KEYS.CLIENT_SECRET);
    ...
    this.http.get<OAuthClientLocal>(AuthService.BASE_CLIENT_URL)
      ...
      .subscribe(
        res => {
          ...
          sharebookLocalStorage.setItem(AuthService.LOCAL_STORAGE_OAUTH_CLIENT_KEYS.CLIENT_ID, this.clientId);
          sharebookLocalStorage.setItem(AuthService.LOCAL_STORAGE_OAUTH_CLIENT_KEYS.CLIENT_SECRET, this.clientSecret);
