...
import {OAuthClientLocal} from "../../shared/models/oauth-client-local.model";
import {UserRefreshToken} from "../../shared/models/users/user-refresh-token.model";
import {MyUser as UserServerModel} from '../../shared/models/users/user.model';
...
Ensure you have correctly configured PeerTube (config/ directory), in particular the "webserver" section.`;
  ...
  refreshAccessToken() {
    if (this.refreshingTokenObservable) {
