import {Func} from "../../../c#-objects/TypeScript.NET-Core/packages/Core/source/FunctionTypes";
...
export static class EnumHelpers
    {
        /// <summary>
        ...
        public static  GetValueWhereAttribute<TEnum, TAttr>(attributePredicate: Func<TAttr, boolean>,
                                                            exceptionMessage: string = null): TEnum;
        {
        ...
        public static  TryGetValueWhereAttribute<TEnum, TAttr>(attributePredicate: Func<TAttr, boolean>,
            /*out*/ val: TEnum): boolean
        {
