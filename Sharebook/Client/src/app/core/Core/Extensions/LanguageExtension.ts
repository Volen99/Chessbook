...
//
// export static class LanguageExtension {
//   public static getLanguageCode(language: Language): string {
//     return language != null ? language.code : language.toString();
//   }
//
//         // public static string GetLanguageCode(this language: LanguageFilter)
//         {
