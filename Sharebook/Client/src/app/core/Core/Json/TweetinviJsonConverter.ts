export interface ITweetinviJsonConverter {
  toJson<TFrom>(obj: TFrom): string;

  toJson<TFrom, TTo>(obj: TFrom): string;

  convertJsonTo<TTo>(json: string): TTo;
}

export class TweetinviJsonConverter implements ITweetinviJsonConverter {
  convertJsonTo<TTo>(json: string): TTo {
    return undefined;
  }
