...
import {ClientHook} from "../../shared/models/plugins/client-hook.model";
import {PluginClientScope} from "../../shared/models/plugins/plugin-client-scope.type";
import {PluginTranslation} from "../../shared/models/plugins/plugin-translation.model";
import {ServerConfigPlugin} from "../../shared/models/server/server-config.model";
import {FormFields, Hooks, PluginInfo} from "../../../root-helpers/plugins";
...
export class PluginService implements ClientHook {
  ...
  private loadTranslations() {
    ...
    if (isDefaultLocale(completeLocale)) {
      this.translationsObservable = of({}).pipe(shareReplay());
    }
