...
const logger = debug('sharebook:tables:RestTable');
...
export abstract class RestTable {
  ...
  loadSort() {
    const result = sharebookLocalStorage.getItem(this.getSortLocalStorageKey());
  ...
  saveSort() {
    sharebookLocalStorage.setItem(this.getSortLocalStorageKey(), JSON.stringify(this.sort));
  }
