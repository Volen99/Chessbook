...
import { ComponentPagination, hasMoreItems, Notifier, RestService } from '../../core';
import { InstanceFollowService } from '../../shared/shared-instance/instance-follow.service';

@Component({
  selector: 'app-about-follows',
...
export class AboutFollowsComponent implements OnInit {
  ...
  constructor(private restService: RestService, private notifier: Notifier, private followService: InstanceFollowService) {
  }
