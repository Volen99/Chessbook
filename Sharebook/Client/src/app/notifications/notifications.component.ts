...
import { UserNotificationService } from '../shared/shared-main';
import { Notifier, SharebookSocket, ScreenService } from '../core';
...
export class NotificationsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.routeSub = this.router.events
      .pipe(filter(event => event instanceof NavigationEnd)) // not the right filter?! 🤔
  ...
  private async subscribeToNotifications() {
    const obs = await this.sharebookSocket.getMyNotificationsSocket();
