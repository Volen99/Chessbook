...
import { ConfirmService, Notifier, RestPagination, RestTable, ServerService } from '../../../core';
import { BytesPipe, RedundancyService } from '../../../shared/shared-main';
import { VideoRedundanciesTarget, VideoRedundancy } from '../../../shared/models';
import { VideosRedundancyStats } from '../../../shared/models';
import { sharebookLocalStorage } from '../../../../root-helpers';

@Component({
  selector: 'app-video-redundancies-list',
...
export class VideoRedundanciesListComponent extends RestTable implements OnInit {
  ...
  private loadSelectLocalStorage() {
    const displayType = sharebookLocalStorage.getItem(VideoRedundanciesListComponent.LOCAL_STORAGE_DISPLAY_TYPE);
    if (displayType) this.displayType = displayType as VideoRedundanciesTarget;
  }

  private saveSelectLocalStorage() {
    sharebookLocalStorage.setItem(VideoRedundanciesListComponent.LOCAL_STORAGE_DISPLAY_TYPE, this.displayType);
  }
}
