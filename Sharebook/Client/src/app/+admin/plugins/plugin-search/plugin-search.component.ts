...
import { PluginApiService } from '../../../+admin/plugins/shared/plugin-api.service';
import { ComponentPagination, ConfirmService, hasMoreItems, Notifier } from '../../../core';
import { SharebookPluginIndex } from '../../../shared/models/plugins/peertube-plugin-index.model';
...
export class PluginSearchComponent implements OnInit {
  ...
  isInstalling(plugin: SharebookPluginIndex) {
    return !!this.installing[plugin.npmName];
  }

  async install(plugin: SharebookPluginIndex) {
