...
import { ComponentPagination, RestExtractor, RestService } from '../../../core';
import { PluginService } from '../../../core/plugins/plugin.service';
import {
  InstallOrUpdatePlugin,
  ManagePlugin,
  PeerTubePlugin,
  SharebookPluginIndex,
  PluginType,
  RegisteredServerSettings,
  ResultList
} from '../../../shared/models';
import { environment } from '../../../../environments/environment';
import { sharebookTranslate } from '../../../shared/core-utils';
...
export class PluginApiService {
  ...
  searchAvailablePlugins(
    ...
    return this.authHttp.get<ResultList<SharebookPluginIndex>>(PluginApiService.BASE_PLUGIN_URL + '/available', { params })
      .pipe(catchError(res => this.restExtractor.handleError(res)));
  }
      ...
      .pipe(
        ...
        map(translations => {
          const registeredSettings = res.registeredSettings
            .map(r => {
              return Object.assign({}, r, { label: sharebookTranslate(r.label, translations) });
            });
