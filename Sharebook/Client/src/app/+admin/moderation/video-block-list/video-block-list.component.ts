...
import { ConfirmService, MarkdownService, Notifier, RestPagination, RestTable, ServerService } from '../../../core';
import { DropdownAction, Video, VideoService } from '../../../shared/shared-main';
import { VideoBlockService } from '../../../shared/shared-moderation';
        ...
        async resultList => {
          ...
          for (const element of this.blocklist) {
            Object.assign(element, {
              ...
              embedHtml: this.sanitizer.bypassSecurityTrustHtml( null /*this.getVideoEmbed(element)*/)
            });
          }
        },
