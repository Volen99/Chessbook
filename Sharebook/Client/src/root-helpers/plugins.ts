...
import {RegisterClientHookOptions} from "../app/shared/models/plugins/register-client-hook.model";
import {ServerConfigPlugin} from "../app/shared/models/server/server-config.model";
import {ClientScript} from "../app/shared/models/plugins/plugin-package-json.model";
import {PluginType} from "../app/shared/models/plugins/plugin.type";
import {
  RegisterClientFormFieldOptions,
  RegisterClientVideoFieldOptions
} from "../app/shared/models/plugins/register-client-form-field.model";
import {ClientHookName, clientHookObject} from "../app/shared/models/plugins/client-hook.model";
import {getHookType, internalRunHook} from "../app/shared/core-utils/plugins/hooks";
