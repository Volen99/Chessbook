import {getCompleteLocale, getShortLocale, is18nLocale, isDefaultLocale} from "../../app/shared/core-utils/i18n/i18n";
...
export class TranslationsManager {
  ...
  private static getLocalePath(serverUrl: string, locale: string) {
    ...
    if (!is18nLocale(completeLocale) || isDefaultLocale(completeLocale)) {
      return undefined;
    }
