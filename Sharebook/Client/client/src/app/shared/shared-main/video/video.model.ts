...
export class Video implements VideoServerModel {
  ...
  constructor(hash: VideoServerModel, translations = {}) {
    ...
    this.category.label = sharebookTranslate(this.category.label, translations);
    this.licence.label = sharebookTranslate(this.licence.label, translations);
    this.language.label = sharebookTranslate(this.language.label, translations);
    this.privacy.label = sharebookTranslate(this.privacy.label, translations);

    this.scheduledUpdate = hash.scheduledUpdate;
    this.originallyPublishedAt = hash.originallyPublishedAt ? new Date(hash.originallyPublishedAt.toString()) : null;

    if (this.state) this.state.label = sharebookTranslate(this.state.label, translations);
