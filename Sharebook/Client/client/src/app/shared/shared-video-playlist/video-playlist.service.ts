...
import { AuthUser, ComponentPaginationLight, RestExtractor, RestService, ServerService } from '../../core';
import { enterZone, leaveZone, objectToFormData } from '../../helpers';
import {
  ResultList,
...
const logger = debug('sharebook:playlists:VideoPlaylistService');
...
export class VideoPlaylistService {
  ...
  private doVideosExistInPlaylist(videoIds: number[]): Observable<VideosExistInPlaylists> {
    ...
    return this.authHttp.get<VideoExistInPlaylist>(url, {
      params,
