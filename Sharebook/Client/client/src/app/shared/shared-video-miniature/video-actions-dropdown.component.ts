...
import { AuthService, ConfirmService, Notifier, ScreenService } from '../../core';
import { BlocklistService, VideoBlockComponent, VideoBlockService, VideoReportComponent } from '../../shared/shared-moderation';
...
@Component({
  selector: 'app-video-actions-dropdown',
