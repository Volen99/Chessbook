...
import { AuthService, ConfirmService, MarkdownService, Notifier, RestPagination, RestTable } from '../../../core';
import { DropdownAction } from '../../../shared/shared-main';
import { BulkService } from '../../../shared/shared-moderation';
import { VideoCommentAdmin, VideoCommentService } from '../../../shared/shared-video-comment';
...
export class VideoCommentListComponent extends RestTable implements OnInit, AfterViewInit {
  ...
  private async removeComments(comments: VideoCommentAdmin[]) {
    const commentArgs = comments.map(c => ({
      videoId: c.video.id,
      commentId: c.id
    }));
