...
import { VIDEO_CHANNEL_DISPLAY_NAME_VALIDATOR, VIDEO_CHANNEL_NAME_VALIDATOR } from '../../shared/form-validators/video-channel-validators';
...
@Component({
  selector: 'app-register-step-channel',
