...
import { HooksService, PluginService, ServerService } from '../../../core';
...
import { VideoCaptionEdit, VideoEdit, VideoService } from '../../../shared/shared-main';
        ...
        this.videoLanguages = res.languages
          .map(l => {
            return res.about.instance.languages.includes(l.id)
              ? {
                ...l,
                group: $localize`Instance languages`,
                groupOrder: 0
              }
              : {
                ...l,
                group: $localize`All languages`,
                groupOrder: 1
              };
          })
