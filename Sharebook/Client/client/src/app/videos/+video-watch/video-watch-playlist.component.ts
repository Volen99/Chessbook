...
import { AuthService, ComponentPagination, LocalStorageService, Notifier, SessionStorageService, UserService } from '../../core';
import { VideoPlaylist, VideoPlaylistElement, VideoPlaylistService } from '../../shared/shared-video-playlist';
import { VideoPlaylistPrivacy } from '../../../../../shared/models';
import { peertubeLocalStorage, peertubeSessionStorage } from '../../../root-helpers';

@Component({
  selector: 'app-video-watch-playlist',
...
export class VideoWatchPlaylistComponent {
  ...
  navigateToNextPlaylistVideo() {
    ...
    this.router.navigate([], {
      queryParams: {
        playlistPosition: next.position,
        start,
        stop
      }
    });
