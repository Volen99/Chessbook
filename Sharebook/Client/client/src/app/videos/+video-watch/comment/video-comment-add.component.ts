...
import { Notifier, User } from '../../../core';
import { VIDEO_COMMENT_TEXT_VALIDATOR } from '../../../shared/form-validators/video-comment-validators';
import { Video } from '../../../shared/shared-main';
import { VideoComment, VideoCommentService } from '../../../shared/shared-video-comment';
...
export class VideoCommentAddComponent extends FormReactive implements OnChanges, OnInit {
  ...
  openEmojiModal(event: any) {
    event.preventDefault();
    this.modalService.open(this.emojiModal, {
      backdrop: true,
      size: 'lg'
    });
  }
